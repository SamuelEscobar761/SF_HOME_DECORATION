export const SellItem = ({image, title, colors, extraColors, discount, previousPrice, price, checked}:{image: string, title: string, colors: string[], extraColors: number, discount: number, previousPrice: number, price: number, checked: boolean}) => {
    return(
        <div className="bg-neutral-300 p-2 text-neutral-900 rounded">
