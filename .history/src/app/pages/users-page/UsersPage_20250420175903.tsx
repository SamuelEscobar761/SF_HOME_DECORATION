...
import { AUTH_NAME_MAP, UserCardComponent } from "../../components/UserCardComponent";
...
export const UsersPage = () => {
  ...
  useEffect(() => {
    ...
    const auths = Manager.getInstance().getAllAuthorizations();
    setAllAuths(auths);
  }, []);
  ...
  return (
    <div id="users-page" className="min-h-screen space-y-4 p-4">
      ...
      {modalOpen && selectedUser && (
        <div className="fixed inset-0 bg-white p-4 overflow-auto z-50">
          <button
            onClick={closeModal}
